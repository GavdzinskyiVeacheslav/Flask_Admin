...
class UserView(ModelView):
    ...
    form_args = {
        ...
        'password': dict(validators=[validators.DataRequired()]),  # label='ПАРОЛЬ',
    }
    ...
    # Описание столбца представления списка или поля формы добавления/редактирования
    ...
    form_excluded_columns = ['id']  # another
    ...
    form_extra_fields = {
        ...
        'image_user': form.ImageUploadField(
            ...
            base_path=os.path.join(file_path, 'blog/static/storage/user_img/'),
            url_relative_path='storage/user_img/',
            namegen=name_gen_image,
            # Список разрешённых расширений. Если не указано, то будут разрешены форматы gif, jpg, jpeg, png и tiff.
