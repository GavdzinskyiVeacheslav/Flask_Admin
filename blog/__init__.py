...
def create_app():
    ...
    from blog.routes import MySignInView, MyLoginView, MyMainView, MyAccountView, MyExitView

    admin = Admin(app, 'Mike do IT', index_view=MyMainView(), template_mode='bootstrap4', url='/')
    # base_template='admin/change_brand.html',
    ...
    admin.add_view(CommentView(Comment, db.session, name='Комментарий', category='Админка', endpoint='admin/comment'))
